/**
 * Array containing data for all projects and repositories.
 * Each object represents a single project card.
 */
const projectsData = [
    {
        id: 1,
...
// Optional: If using ES6 modules (recommended for modern projects)
